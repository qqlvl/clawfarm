      ...
      <div class="landing-hero">
        ...
        <div class="token-contract">
          ...
          <div class="token-address-wrap">
            <input type="text" class="token-address" value="3PijQsE9kQ3QU9VhQhMaZ1EE59RKxwPJexTHTHsNpump" readonly />
            ...
            <a href="https://pump.fun/coin/3PijQsE9kQ3QU9VhQhMaZ1EE59RKxwPJexTHTHsNpump" target="_blank" rel="noopener" class="token-btn token-pump" title="View on pump.fun">
              pump.fun
            </a>
          </div>
        </div>
